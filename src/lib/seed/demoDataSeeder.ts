...
export { DEMO_10_APPLICATIONS, type DemoApplicationSeed } from "./demoData.ts";
...
export function getDemoSmartCheckForApp(id: string) {
  ...
  return [
    ...
    },
    {
      ...
      ruleSetVersion: "1.0.0",
      category: "SETBACK",
      status: isApp2 ? "NON_COMPLIANT" : "COMPLIANT",
      severity: "HIGH",
    ...
    },
    {
      ...
      ruleSetVersion: "1.0.0",
      category: "PARKING",
      status: isApp3 ? "NON_COMPLIANT" : "COMPLIANT",
      severity: "MEDIUM",
